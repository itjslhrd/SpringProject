...
public class BoardPhotoController {
	...
	public String boardList(@ModelAttribute("page") int page, PageSearchDTO pageSearchDTO, Model model) {
		...
		int totcount = boardPhotoService.boardCount(pageSearchDTO);//총 글수0;//총 글수
/*
		if(pageSearchDTO.getKey() != null)
			totcount = boardPhotoService.boardCount(pageSearchDTO.getSearch(), pageSearchDTO.getKey());//총 글수
		else
