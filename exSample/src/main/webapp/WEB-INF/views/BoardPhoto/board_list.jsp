...
<c:forEach var="board" items="${bList}">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/BoardPhoto/board_list?page=${page}&idx=${board.idx}">${board.subject}</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="board" method="post" action="/BoardPhoto/board_list?page=${page}">		
			...
			<a href="/BoardPhoto/board_write?page=${page}"><img src="/Images/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
